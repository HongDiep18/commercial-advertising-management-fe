...
const products = {
  "vietnam-guide-2025": {
    ...
    pages: 672,
    year: 2025,
    description: "伴隨著社會的發展，每年都會建立起各經濟部門的許多企業。為了在尋找客戶的過程中為企業提供支持和創造有利條件，KIEN HAO CO.,LTD 作為連接平台每年出版《華商採購名錄》，越中雙語的具有多維查找系統、科學結構。《華商採購名錄》允許用戶快速以及輕鬆地查找在全越南有運營的數千家企業的必要信息。",
    features: [
      "出版社：NXB HONG DUC",
      "作者：阮氏青草 著",
      "頁數：672",
  ...
  "vietnam-guide-2024": {
    ...
    pages: 656,
    year: 2024,
    description: "《2024越南華商採購名錄》是建豪公司連續出版的第九版華商採購名錄，延續多年來為在越華商企業提供便捷查找平台的使命。本版名錄收錄全越南超過2800家華商企業的完整資訊，涵蓋各主要經濟部門，是連接供需雙方、促進商業合作的重要橋樑。",
    features: [
      "出版社：NXB HONG DUC",
      "作者：阮氏青草 著",
      "頁數：656",
  ...
  "taiwan-tea-1": {
    ...
    origin: "台灣阿里山",
    weight: "300G",
    description: "台灣情阿里山烏龍茶，產自海拔1200-1400公尺的阿里山高山茶區。得天獨厚的高山雲霧環境，孕育出茶葉獨特的清香與甘甜。每片茶葉都經過嚴格篩選，採用一心二葉採摘標準，確保茶葉品質。茶湯色澤金黃明亮，香氣清雅持久，滋味醇厚回甘，是品茗與送禮的上乘之選。",
    features: [
      "產地：台灣阿里山茶區",
      "海拔：1200-1400公尺",
      "重量：300G",
  ...
  "taiwan-tea-2": {
    ...
    origin: "台灣高山茶區",
    weight: "150G",
    description: "台灣情嚴選高山烏龍茶，精選台灣中部高海拔茶區優質茶葉。高山茶園終年雲霧繚繞，日照充足但不強烈，晝夜溫差大，使茶葉生長緩慢，積累豐富的內含物質。茶葉嫩綠飽滿，香氣濃郁，口感清爽甘醇，韻味悠長，是日常品飲與待客的理想選擇。",
    features: [
      "產地：台灣高山茶區",
      "重量：150G",
      "包裝：環保盒裝",
  ...
  "tea-gift-1": {
    ...
    origin: "台灣高山茶區",
    weight: "200G",
    description: "台灣情高山烏龍茶禮盒，精選台灣中部高海拔茶區的優質烏龍茶，以精美環保禮盒包裝。茶葉在高山雲霧環境中生長，吸收天地精華，茶香清雅，滋味甘醇。禮盒設計典雅大方，既展現台灣茶文化底蘊，又符合現代環保理念，是商務往來、節慶送禮的最佳選擇。",
    features: [
      "產地：台灣高山茶區",
      "重量：200G",
      "包裝：精美環保禮盒",
  ...
  "tea-gift-2": {
    ...
    origin: "台灣各大茶區",
    weight: "組合裝",
    description: "台灣情精選茶葉禮盒，嚴選台灣各大知名茶區的優質茶葉，包含阿里山烏龍茶、凍頂烏龍茶、高山金萱茶等多款經典茶品。每款茶葉都經過專業茶師精心挑選，獨立小包裝保鮮，搭配豪華禮盒，展現台灣茶葉的多元風味。無論是自品或送禮，都能讓收禮者感受到台灣茶文化的精髓與誠意。",
    features: [
      "產地：台灣各大知名茶區",
      "內容：多款台灣經典茶品",
      "包裝：豪華禮盒裝",
      ...
      <div className="pt-14">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
              ...
              {product.details && product.details.length > 0 && (
                <div className="mb-6 p-4 bg-[#ECE9E1] rounded-lg">
                  <div className="space-y-2">
              ...
              <div className="mb-4">
                <p className="text-sm text-muted-foreground">
                  {t('store.detail.productCode')}: <span className="text-foreground">{product.code}</span>
                </p>
                <p className="text-sm text-muted-foreground">
                  {t('store.detail.supplyStatus')}: <span className="text-primary font-medium">{product.stock}</span>
                </p>
              </div>

              {/* Size Selector - Only for Vietnam Guide */}
              {product.category === "越南華商採購名錄" && product.sizes && product.sizes.length > 0 && (
                <div className="mb-6">
                  ...
                  <div className="flex gap-2">
                    {product.sizes.map((size) => (
                      <button
                        ...
                        className={`px-6 py-2 rounded-md border font-medium text-sm transition-colors ${
                          selectedSize === size
              ...
              {/* Quantity Selector */}
              <div className="mb-6">
                <label className="block text-sm font-medium mb-2">{t('store.detail.quantity')}</label>
                <div className="flex items-center border border-gray-300 rounded-md w-fit">
                  ...
                  <input
                    ...
                    className="w-16 text-center border-x border-gray-300 py-2 bg-transparent focus:outline-none"
                  />
                  <button
                    onClick={() => handleQuantityChange(1)}
                    className="px-4 py-2 hover:bg-muted transition-colors"
              ...
              <div className="flex gap-3">
                <Button
                  size="lg"
                  className="flex-1 border border-black !text-black bg-transparent hover:bg-white"
                >
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="bg-body-bg-light border border-border rounded-lg p-8">
              <h2 className="text-2xl font-bold text-foreground mb-6">{t('store.detail.productIntroduction')}</h2>
              <div className="prose max-w-none">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
                  ...
                  <div className="col-span-1 md:col-span-2 rounded-lg overflow-hidden border border-border">
                    <img
                      src="/assets/images/companies/modern-tech-office.png"
                      alt="越南華商採購名錄內頁展示"
                      className="w-full h-auto object-contain"
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-foreground">{t('store.detail.relatedProducts')}</h2>
              <Link
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              {product.id === "vietnam-guide-2025" && (
                <Link
                  ...
                  className="group"
                >
                  <div className="relative aspect-square bg-card rounded-lg overflow-hidden mb-3 border border-border">
                    <img
                  ...
                  <h3 className="text-sm font-medium mb-1 group-hover:underline line-clamp-2">
                    2024 越南華商採購名錄
                  </h3>
              ...
              {product.id === "taiwan-tea-1" && (
                <Link
                  href="/store/taiwan-tea-2?fromCategory=台灣茶葉"
                  className="group"
                >
                  <div className="relative aspect-square bg-card rounded-lg overflow-hidden mb-3 border border-border">
                    <img
              ...
              {product.id === "taiwan-tea-2" && (
                <Link
                  href="/store/taiwan-tea-1?fromCategory=台灣茶葉"
                  className="group"
                >
                  <div className="relative aspect-square bg-card rounded-lg overflow-hidden mb-3 border border-border">
                    <img
              ...
              {product.id === "tea-gift-1" && (
                <Link
                  href="/store/tea-gift-2?fromCategory=茶葉禮品"
                  className="group"
                >
                  <div className="relative aspect-square bg-card rounded-lg overflow-hidden mb-3 border border-border">
                    <img
              ...
              {product.id === "tea-gift-2" && (
                <Link
                  href="/store/tea-gift-1?fromCategory=茶葉禮品"
                  className="group"
                >
                  <div className="relative aspect-square bg-card rounded-lg overflow-hidden mb-3 border border-border">
                    <img
