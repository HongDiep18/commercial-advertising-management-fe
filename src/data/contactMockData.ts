...
export const platformPricing = {
  popup: {
    ...
    items: [
      {
        id: "popup-priority-1m",
        name: "優先顯示（第1順位）",
        duration: "1個月",
        price: "2,500,000",
      },
      {
        id: "popup-priority-3m",
        name: "優先顯示（第1順位）",
        duration: "3個月",
        price: "6,375,000",
        discount: "15%",
...
export const getDurationMonths = (duration: string): number => {
  ...
  if (d.includes("1年") || d.includes("1 year") || d.includes("1 năm")) return 12
