...
export const mockCompanies: Record<string, Company> = {
    'textile-1': {
        ...
        address: 'Lô A-6-CN, Đường N7, khu công nghiệp Mỹ Phước, Phường Mỹ Phước, Thị xã Bến Cát, Tỉnh Bình Dương',
    ...
    'finance-1': {
        ...
        phone: '+84 (90) 8489826 (江炎燊 Eason) / +84 (90) 8310468 (任佩盈) / +84 (778) 869122 (韋瑞淵) / +84 0983 125 983 (李佩瑩)',
        email: 'giangdiemtan@dbs.com / nhamdinhdinh@dbs.com / vythuyuyen@dbs.com / chungphoidieu@dbs.com',
        website: 'www.dbs.com/vn',
        contactPerson: '江炎燊 Eason Giang Diem Tan / 任佩盈 Nham Dinh Dinh / 韋瑞淵 Vy Thuy Uyen / 李佩瑩 Chung Phoi Dieu',
        region: '新加坡',
        taxId: '0310011749',
        employeeCount: '1235',
        introduction:
...
export function getCompanyData(id: string): Company {
    ...
    const categoryInfo = categoryMap[categoryPrefix] || { cn: '企業', en: 'Company', category: '其他服務業' }
